...
contract GiniNFT is ERC721, Ownable {
    ...
    struct GiniProfile {
        ...
        address _peer;
        uint8 _level;
        uint256 _giniXPoints;
        uint256 _blockNumber;
    }

    mapping(uint256 => GiniProfile) private _tokenURIs;
    ...
    function mint(
        ...
        _addressTokenId[_peer] = ++tokenCounter;
        _mint(_peer, tokenCounter);
        _setGiniProfile(
            tokenCounter,
            GiniProfile(
                tokenCounter,
    ...
    function _setGiniProfile(uint256 tokenId, GiniProfile memory peerProfile)
        internal
        virtual
    {
        require(_exists(tokenId), "URI set of nonexistent token");
        _tokenURIs[tokenId] = peerProfile;
    }
    ...
    function updateProfile(
        ...
        _tokenURIs[_tokenId]._giniXPoints = _giniXPoints;
        _tokenURIs[_tokenId]._level = _level;
        _tokenURIs[_tokenId]._blockNumber = block.timestamp;
    }
        ...
        returns (string memory)
    {
        ...
        string memory description = "Peer Gini Profile";
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    toAsciiString(_tokenURIs[tokenId]._peer),
                    "</text>",
                    ...
                    toString(_tokenURIs[tokenId]._level),
                    "</text>",
                    "</svg>"
                )
            );
